...
const ProfileMenuScreen: React.FC<ProfileMenuProps> = ({ setIsProfileFormVisible, slideAnim }) => {
  const handleSignIn = () => {
      console.log('Sign In button pressed');
      closeProfileForm(slideAnim, setIsProfileFormVisible, () => {
          console.log('Navigating to Sign In');
          // Assuming you have access to navigation here
          // You might need to pass navigation as a prop or use useNavigation hook
      });
  };
