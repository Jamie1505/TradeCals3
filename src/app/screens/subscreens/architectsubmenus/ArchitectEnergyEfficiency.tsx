...
const ArchitectEnergyEfficiencyScreen = () => {
  const { addFavorite, removeFavorite, favorites } = useFavorites();

  // Check if the screen is a favorite
  const isFavorite = favorites.includes('ArchitectEnergyEfficiency');

  // Toggle favorite functionality
  const handleFavoritePress = () => {
    if (isFavorite) {
      removeFavorite('ArchitectEnergyEfficiency');
    } else {
      addFavorite('ArchitectEnergyEfficiency');
    }
  };
...
export default ArchitectEnergyEfficiencyScreen;
