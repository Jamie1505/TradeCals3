...
const MechanicBasicCals= () => {
    const { addFavorite, removeFavorite, favorites } = useFavorites();

    // Check if the screen is a favorite
    const isFavorite = favorites.includes('MechanicalBasicCals');
  
    // Toggle favorite functionality
    const handleFavoritePress = () => {
      if (isFavorite) {
        removeFavorite('MechanicalBasicCals');
      } else {
        addFavorite('MechanicalBasicCals');
      }
    };
...
export default MechanicBasicCals;