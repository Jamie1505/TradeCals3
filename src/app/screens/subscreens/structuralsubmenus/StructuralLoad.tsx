...
const StructuralLoadScreen= () => {
    const { addFavorite, removeFavorite, favorites } = useFavorites();

    // Check if the screen is a favorite
    const isFavorite = favorites.includes('StructuralLoad');
  
    // Toggle favorite functionality
    const handleFavoritePress = () => {
      if (isFavorite) {
        removeFavorite('StructuralLoad');
      } else {
        addFavorite('StructuralLoad');
      }
    };
...
export default StructuralLoadScreen;