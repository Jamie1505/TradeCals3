...
const StructuralFoundationsScreen= () => {
    const { addFavorite, removeFavorite, favorites } = useFavorites();

    // Check if the screen is a favorite
    const isFavorite = favorites.includes('StructuralFoundations');
  
    // Toggle favorite functionality
    const handleFavoritePress = () => {
      if (isFavorite) {
        removeFavorite('StructuralFoundations');
      } else {
        addFavorite('StructuralFoundations');
      }
    };
...
export default StructuralFoundationsScreen;